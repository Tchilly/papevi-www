...
<template>
    <DocsLayout>
        ...
        <div class="space-y-10">
            ...
            <!-- Overview -->
            <div class="space-y-4">
                <Heading as="h2" id="overview" :level="3" class="scroll-mt-24">Overview</Heading>
                ...
                <div class="grid gap-3 sm:grid-cols-3 text-sm">
                    <div class="rounded-xl border border-gray-200 p-4 dark:border-white/10">
                        ...
                        <p class="mt-1 text-gray-500 dark:text-gray-400">Every response has the same top-level shape.</p>
                    </div>
                    <div class="rounded-xl border border-gray-200 p-4 dark:border-white/10">
                        <p class="font-medium text-gray-900 dark:text-white">Self-describing</p>
                        <p class="mt-1 text-gray-500 dark:text-gray-400">Resources carry a <code class="font-mono text-xs">type</code> and string <code class="font-mono text-xs">id</code>.</p>
                    </div>
                    <div class="rounded-xl border border-gray-200 p-4 dark:border-white/10">
                        <p class="font-medium text-gray-900 dark:text-white">Efficient</p>
                        <p class="mt-1 text-gray-500 dark:text-gray-400">Related resources are sideloaded once in <code class="font-mono text-xs">included</code>.</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Content type -->
            <div class="space-y-4">
                <Heading as="h2" id="content-type" :level="3" class="scroll-mt-24">Content type</Heading>
                <p class="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
                ...
                <div class="overflow-hidden rounded-xl border border-white/10 bg-gray-950">
                    <Code lang="bash" code="Content-Type: application/vnd.api+json" />
                </div>
            </div>

            <!-- Resource objects -->
            <div class="space-y-4">
                <Heading as="h2" id="resource-objects" :level="3" class="scroll-mt-24">Resource objects</Heading>
                <p class="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 text-gray-700 dark:divide-white/8 dark:text-gray-200">
                            <tr>
                                ...
                                <td class="px-5 py-3">Resource type name (e.g. <code class="font-mono text-xs">pages</code>, <code class="font-mono text-xs">menus</code>)</td>
                            </tr>
                            <tr>
                                <td class="px-5 py-3"><code class="font-mono text-xs">id</code></td>
                                <td class="px-5 py-3 text-xs text-gray-500">string</td>
                                <td class="px-5 py-3">Resource identifier — always a string even when the underlying value is numeric</td>
                            </tr>
                            <tr>
                                <td class="px-5 py-3"><code class="font-mono text-xs">attributes</code></td>
                                <td class="px-5 py-3 text-xs text-gray-500">object</td>
                                <td class="px-5 py-3">Resource fields. Foreign keys are never exposed here — use relationships instead</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div class="overflow-hidden rounded-xl border border-white/10 bg-gray-950">
                    <Code lang="json" :code="singleResourceExample" />
                </div>
            </div>

            <!-- Collections -->
            <div class="space-y-4">
                <Heading as="h2" id="collections" :level="3" class="scroll-mt-24">Collections</Heading>
                <p class="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 text-gray-700 dark:divide-white/8 dark:text-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-5 py-3">Filter by field value. See each resource's docs for supported filters.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="overflow-hidden rounded-xl border border-white/10 bg-gray-950">
                    <Code lang="json" :code="collectionExample" />
                </div>
            </div>

            <!-- Relationships -->
            <div class="space-y-4">
                <Heading as="h2" id="relationships" :level="3" class="scroll-mt-24">Relationships &amp; includes</Heading>
                <p class="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
                ...
                <p class="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
                    When included, the primary resource lists related resource identifiers in <code class="rounded bg-gray-100 px-1.5 py-0.5 font-mono text-xs dark:bg-gray-800">relationships</code>. The full resource objects appear in the top-level <code class="rounded bg-gray-100 px-1.5 py-0.5 font-mono text-xs dark:bg-gray-800">included</code> array — each resource appears only once even if referenced multiple times.
                </p>
                <div class="overflow-hidden rounded-xl border border-white/10 bg-gray-950">
                    <Code lang="json" :code="relationshipExample" />
                </div>
                <div class="overflow-x-auto rounded-xl border border-gray-200 dark:border-white/10">
                    <table class="w-full text-sm">
                        <thead class="bg-gray-50 text-xs text-gray-500 dark:bg-white/[0.03] dark:text-gray-400">
            ...
            <!-- Error objects -->
            <div class="space-y-4">
                <Heading as="h2" id="error-objects" :level="3" class="scroll-mt-24">Error objects</Heading>
                <p class="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
                ...
                <div class="overflow-hidden rounded-xl border border-white/10 bg-gray-950">
                    <Code lang="json" :code="errorExample" />
                </div>
                <div class="overflow-x-auto rounded-xl border border-gray-200 dark:border-white/10">
                    <table class="w-full text-sm">
                        <thead class="bg-gray-50 text-xs text-gray-500 dark:bg-white/[0.03] dark:text-gray-400">
                        ...
                        <tbody class="divide-y divide-gray-100 text-gray-700 dark:divide-white/8 dark:text-gray-200">
                            <tr>
                                <td class="px-5 py-3"><code class="font-mono text-xs text-red-600 dark:text-red-400">401</code></td>
                                <td class="px-5 py-3">Unauthorized</td>
                                <td class="px-5 py-3">Missing or invalid API token</td>
                            </tr>
                            <tr>
                                <td class="px-5 py-3"><code class="font-mono text-xs text-red-600 dark:text-red-400">403</code></td>
                                <td class="px-5 py-3">Forbidden</td>
                                <td class="px-5 py-3">Token used from an unverified domain</td>
                            </tr>
                            <tr>
                                <td class="px-5 py-3"><code class="font-mono text-xs text-red-600 dark:text-red-400">404</code></td>
                                <td class="px-5 py-3">Not Found</td>
                                <td class="px-5 py-3">Resource doesn't exist or doesn't belong to your site</td>
                            </tr>
                            <tr>
                                <td class="px-5 py-3"><code class="font-mono text-xs text-red-600 dark:text-red-400">405</code></td>
                                <td class="px-5 py-3">Method Not Allowed</td>
                                <td class="px-5 py-3">HTTP method not supported on this endpoint</td>
                            </tr>
                            <tr>
                                <td class="px-5 py-3"><code class="font-mono text-xs text-red-600 dark:text-red-400">429</code></td>
                                <td class="px-5 py-3">Too Many Requests</td>
                                <td class="px-5 py-3">Rate limit exceeded — check <code class="font-mono text-xs">meta.retry_after</code></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <!-- Version member -->
            <div class="space-y-4">
                <Heading as="h2" id="version-member" :level="3" class="scroll-mt-24">Version member</Heading>
                <p class="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
                ...
                <div class="overflow-hidden rounded-xl border border-white/10 bg-gray-950">
                    <Code lang="json" code='{ "jsonapi": { "version": "1.1" } }' />
                </div>
            </div>
        </div>
    </DocsLayout>
