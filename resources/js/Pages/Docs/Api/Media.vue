...
<template>
    <DocsLayout>
        ...
        <div class="space-y-10">
            ...
            <!-- GET /media -->
            <div class="space-y-4">
                <Heading as="h2" id="get-media" :level="3" class="scroll-mt-24">GET /media</Heading>
  ...
  -H <span class="text-brand-300">"Authorization: Bearer &lt;token&gt;"</span></code></pre>
                        ...
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-100 text-gray-700 dark:divide-white/8 dark:text-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-5 py-3">One of <code class="font-mono text-xs">filename</code>, <code class="font-mono text-xs">size</code>, <code class="font-mono text-xs">created_at</code>, <code class="font-mono text-xs">updated_at</code>. Prefix with <code class="font-mono text-xs">-</code> for descending (default <code class="font-mono text-xs">-created_at</code>)</td>
                                </tr>
                                <tr>
                                    <td class="px-5 py-3"><code class="font-mono text-xs">filter[type]</code></td>
                                    <td class="px-5 py-3 text-xs text-gray-500">string</td>
                                    <td class="px-5 py-3">Filter by media type (e.g. <code class="font-mono text-xs">image</code>, <code class="font-mono text-xs">video</code>)</td>
                                </tr>
                                <tr>
                                    <td class="px-5 py-3"><code class="font-mono text-xs">filter[mime_type]</code></td>
                                    <td class="px-5 py-3 text-xs text-gray-500">string</td>
                                    <td class="px-5 py-3">Filter by MIME type (e.g. <code class="font-mono text-xs">image/jpeg</code>)</td>
                                </tr>
                                <tr>
                ...
                <pre class="overflow-x-auto rounded-xl border border-white/10 bg-gray-950 p-5 text-sm leading-relaxed"><code class="font-mono text-gray-100"><span class="text-gray-500"># Fetch all images, 20 per page</span>
curl <span class="text-brand-300">"https://api.papevi.app/api/v1/media?filter[type]=image&amp;per_page=20"</span> \
  -H <span class="text-brand-300">"Authorization: Bearer &lt;token&gt;"</span></code></pre>
            ...
            <!-- GET /media/{id} -->
            <div class="space-y-4">
                <Heading as="h2" id="get-media-id" :level="3" class="scroll-mt-24">GET /media/{id}</Heading>
  ...
  -H <span class="text-brand-300">"Authorization: Bearer &lt;token&gt;"</span></code></pre>
            ...
            <div class="space-y-4">
                ...
                <pre class="overflow-x-auto rounded-xl border border-white/10 bg-gray-950 p-5 text-sm leading-relaxed"><code class="font-mono text-gray-100"><span class="text-gray-500">// GET /media/{id}</span>
{
            ...
            <div class="space-y-4">
                ...
                <div class="overflow-x-auto rounded-xl border border-gray-200 dark:border-white/10">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 text-gray-700 dark:divide-white/8 dark:text-gray-200">
                            <tr><td class="px-5 py-3"><code class="font-mono text-xs">type</code></td><td class="px-5 py-3 text-xs text-gray-500">string</td><td class="px-5 py-3">General media type (e.g. <code class="font-mono text-xs">image</code>, <code class="font-mono text-xs">video</code>)</td></tr>
                            <tr><td class="px-5 py-3"><code class="font-mono text-xs">filename</code></td><td class="px-5 py-3 text-xs text-gray-500">string</td><td class="px-5 py-3">Stored filename (URL-safe)</td></tr>
                            <tr><td class="px-5 py-3"><code class="font-mono text-xs">original_filename</code></td><td class="px-5 py-3 text-xs text-gray-500">string</td><td class="px-5 py-3">Original filename as uploaded</td></tr>
                            <tr><td class="px-5 py-3"><code class="font-mono text-xs">mime_type</code></td><td class="px-5 py-3 text-xs text-gray-500">string</td><td class="px-5 py-3">MIME type (e.g. <code class="font-mono text-xs">image/jpeg</code>)</td></tr>
                            <tr><td class="px-5 py-3"><code class="font-mono text-xs">size</code></td><td class="px-5 py-3 text-xs text-gray-500">integer</td><td class="px-5 py-3">File size in bytes</td></tr>
                            <tr><td class="px-5 py-3"><code class="font-mono text-xs">alt</code></td><td class="px-5 py-3 text-xs text-gray-500">string|null</td><td class="px-5 py-3">Alt text for the media</td></tr>
                            <tr><td class="px-5 py-3"><code class="font-mono text-xs">caption</code></td><td class="px-5 py-3 text-xs text-gray-500">string|null</td><td class="px-5 py-3">Optional caption</td></tr>
                            <tr><td class="px-5 py-3"><code class="font-mono text-xs">dimensions</code></td><td class="px-5 py-3 text-xs text-gray-500">object|null</td><td class="px-5 py-3">Width and height (images only)</td></tr>
                            <tr><td class="px-5 py-3"><code class="font-mono text-xs">metadata</code></td><td class="px-5 py-3 text-xs text-gray-500">object</td><td class="px-5 py-3">Additional metadata (EXIF, etc.)</td></tr>
                            <tr><td class="px-5 py-3"><code class="font-mono text-xs">url</code></td><td class="px-5 py-3 text-xs text-gray-500">string|null</td><td class="px-5 py-3">CDN URL for the original file</td></tr>
                            <tr><td class="px-5 py-3"><code class="font-mono text-xs">view_url</code></td><td class="px-5 py-3 text-xs text-gray-500">string|null</td><td class="px-5 py-3">URL for in-browser viewing</td></tr>
                            <tr><td class="px-5 py-3"><code class="font-mono text-xs">thumbnail_url</code></td><td class="px-5 py-3 text-xs text-gray-500">string|null</td><td class="px-5 py-3">URL for the generated thumbnail preview</td></tr>
                            <tr><td class="px-5 py-3"><code class="font-mono text-xs">variants</code></td><td class="px-5 py-3 text-xs text-gray-500">object|null</td><td class="px-5 py-3">Resized variants keyed by size name</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
