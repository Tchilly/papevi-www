    ...
    <DocsLayout>
        ...
        <div class="space-y-10">
            <div class="space-y-3 border-b border-gray-200 pb-10 dark:border-white/8">
                ...
                <Heading as="h1" :level="1" class="text-gray-900 dark:text-white">Menus API</Heading>
            ...
            <!-- GET /menus -->
            <div class="space-y-4">
                <Heading as="h2" id="get-menus" :level="3" class="scroll-mt-24 text-gray-900 dark:text-white">GET /menus</Heading>
...
curl <span class="text-brand-300">"https://api.papevi.app/api/v1/menus?filter[is_primary]=true&amp;include=items"</span> \
  -H <span class="text-brand-300">"Authorization: Bearer &lt;token&gt;"</span></code></pre>
            ...
            <!-- GET /menus/{slug} -->
            <div class="space-y-4">
                <Heading as="h2" id="get-menus-id" :level="3" class="scroll-mt-24 text-gray-900 dark:text-white">GET /menus/{slug}</Heading>
