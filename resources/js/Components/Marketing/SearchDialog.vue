...
const entries: Entry[] = [
    {
        ...
        body: 'Architecture, stack, and how Papevi fits together.',
        href: '/docs#developer',
    },
    {
        section: 'Docs',
    ...
    },
    {
        section: 'Docs',
        title: 'Page types',
        body: 'Schema-per-type modeling with reusable blocks.',
        href: '/docs#page-types',
    },
    {
        section: 'Docs',
        title: 'Editor help',
        body: 'Authoring, review, comments, and publishing.',
        href: '/docs#editor',
    },
    {
        section: 'Docs',
        title: 'Roles & permissions',
        body: 'Predefined roles and the permission system.',
        href: '/docs#roles',
    },
    {
        section: 'Docs',
        title: 'Workflow & scheduling',
        body: 'Draft → review → approved → scheduled → published.',
        href: '/docs#workflow',
    },
    {
        section: 'Docs',
    ...
    },
    {
        ...
        body: 'API-first delivery for any channel.',
        href: '/docs#developer',
    },
    {
        section: 'Platform',
        title: 'Multi-tenancy',
        body: 'One install, many organizations and sites.',
        href: '/docs#developer',
    },
    {
        section: 'Platform',
        title: 'Audit & versioning',
        body: 'Full revision history with user context.',
        href: '/docs#workflow',
    },
];
