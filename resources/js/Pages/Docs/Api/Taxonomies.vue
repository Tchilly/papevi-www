        ...
        <div class="space-y-10">
            <div class="space-y-3 border-b border-gray-200 pb-10 dark:border-white/8">
                ...
                <p class="max-w-xl text-lg text-gray-600 dark:text-gray-300">
                    Fetch taxonomies and their terms for your site. Taxonomies categorise content — include terms to get
                    the full hierarchy in one request.
                </p>
            </div>
            ...
            <div class="space-y-4">
                <Heading
                    ...
                    :level="3"
                    class="scroll-mt-24"
                    >GET /taxonomies/{id}</Heading
                >
                <p class="text-sm text-gray-600 dark:text-gray-300">
                    Returns a single taxonomy. Returns
