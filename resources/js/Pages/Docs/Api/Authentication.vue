        ...
        <div class="space-y-10">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="rounded-xl border border-gray-200 p-5 dark:border-white/10">
                        <div class="mb-3 flex items-center gap-2">
                            <span class="rounded-full border border-green-300 bg-green-50 px-2 py-0.5 text-xs font-medium text-green-700 dark:border-green-500/30 dark:bg-green-500/10 dark:text-green-400">Dev</span>
                        </div>
                        ...
                        <ul class="mt-3 space-y-1.5 text-sm text-gray-600 dark:text-gray-300">
                            <li class="flex gap-2"><span class="text-green-600 dark:text-green-400">✓</span> Works from <code class="rounded bg-gray-100 px-1 font-mono text-xs dark:bg-gray-800">localhost</code>, <code class="rounded bg-gray-100 px-1 font-mono text-xs dark:bg-gray-800">*.dev</code>, <code class="rounded bg-gray-100 px-1 font-mono text-xs dark:bg-gray-800">*.test</code></li>
                            <li class="flex gap-2"><span class="text-green-600 dark:text-green-400">✓</span> No domain verification required</li>
                            <li class="flex gap-2"><span class="text-red-500 dark:text-red-400">✗</span> Cannot be used from production domains</li>
                        </ul>
                    </div>
                    <div class="rounded-xl border border-brand-200 p-5 dark:border-brand-400/30">
                        <div class="mb-3 flex items-center gap-2">
                            <span class="rounded-full border border-brand-300 bg-brand-50 px-2 py-0.5 text-xs font-medium text-brand-700 dark:border-brand-500/30 dark:bg-brand-500/10 dark:text-brand-400">Production</span>
                        </div>
                        <p class="text-sm font-medium text-gray-900 dark:text-white">Production token</p>
                        <ul class="mt-3 space-y-1.5 text-sm text-gray-600 dark:text-gray-300">
                            <li class="flex gap-2"><span class="text-green-600 dark:text-green-400">✓</span> Requires at least one verified domain</li>
                            <li class="flex gap-2"><span class="text-green-600 dark:text-green-400">✓</span> Domain ownership verified via DNS TXT</li>
                            <li class="flex gap-2"><span class="text-green-600 dark:text-green-400">✓</span> Recommended for live applications</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="overflow-hidden rounded-xl border border-white/10 bg-gray-950">
                    <Code code="Authorization: Bearer <your-token>" lang="bash" />
                </div>

                <CodeTabs>
                    <Code label="curl" lang="bash" :code="headerCurlExample" />
                    <Code label="TypeScript" lang="typescript" :code="headerTsExample" />
                    <Code label="PHP" lang="php" :code="headerPhpExample" />
                    <Code label="C#" lang="csharp" :code="headerCsharpExample" />
                </CodeTabs>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="overflow-hidden rounded-xl border border-white/10 bg-gray-950">
                    <Code lang="bash" :code="testCurlExample" />
                </div>

                <div class="overflow-hidden rounded-xl border border-white/10 bg-gray-950">
                    <Code lang="json" :code="testResponseExample" />
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <CodeTabs>
                    <Code label="TypeScript" lang="typescript" :code="frameworkExamples['TypeScript']" />
                    <Code label="PHP" lang="php" :code="frameworkExamples['PHP']" />
                    <Code label="C#" lang="csharp" :code="frameworkExamples['C#']" />
                </CodeTabs>
            </div>
            ...
            <div class="space-y-4">
                    ...
                    <table class="w-full font-mono text-xs text-gray-300">
                        <thead>
                            <tr class="border-b border-white/10 text-gray-500">
                                <th class="pb-2 pr-10 text-left font-medium">Type</th>
                                <th class="pb-2 pr-10 text-left font-medium">Host</th>
                                <th class="pb-2 pr-10 text-left font-medium">TTL</th>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">DNS propagation typically takes 5–30 minutes. Click <strong>Verify</strong> once the record is live.</p>
            </div>
            ...
            <div class="space-y-4">
                        ...
                        <div class="mt-3 overflow-x-auto">
                            <table class="w-full text-sm">
                                <thead class="text-xs text-gray-500 dark:text-gray-400">
                                    <tr>
                                        <th class="pb-2 pr-10 text-left font-medium">Plan</th>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-300">
                    To revoke a token go to <strong class="font-medium text-gray-900 dark:text-white">Site Settings → API Tokens</strong>, click the trash icon, and confirm. Revocation is immediate and permanent.
                </p>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="grid gap-3 sm:grid-cols-2 text-sm">
                    ...
                    <div class="rounded-xl border border-red-200 bg-red-50/50 p-4 dark:border-red-500/20 dark:bg-red-500/5">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex gap-4 rounded-lg border border-gray-200 p-4 dark:border-white/10">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 dark:text-gray-400">No Bearer token was provided in the Authorization header.</p>
                        </div>
                    </div>
                    <div class="flex gap-4 rounded-lg border border-gray-200 p-4 dark:border-white/10">
                        <code class="shrink-0 font-mono text-red-600 dark:text-red-400">401</code>
                        <div>
                            ...
                            <p class="text-gray-500 dark:text-gray-400">Token is incorrect, expired, or has been revoked.</p>
                        </div>
                    </div>
                    <div class="flex gap-4 rounded-lg border border-gray-200 p-4 dark:border-white/10">
                        <code class="shrink-0 font-mono text-red-600 dark:text-red-400">403</code>
                        <div>
                            <p class="font-medium text-gray-900 dark:text-white">This site is inactive. API access is disabled.</p>
                            <p class="text-gray-500 dark:text-gray-400">The site associated with this token has been deactivated.</p>
                        </div>
                    </div>
                    <div class="flex gap-4 rounded-lg border border-gray-200 p-4 dark:border-white/10">
                        <code class="shrink-0 font-mono text-red-600 dark:text-red-400">403</code>
                        <div>
                            <p class="font-medium text-gray-900 dark:text-white">Development tokens can only be used from development environments</p>
                            <p class="text-gray-500 dark:text-gray-400">Dev tokens are restricted to local or development domains.</p>
                        </div>
                    </div>
                    <div class="flex gap-4 rounded-lg border border-gray-200 p-4 dark:border-white/10">
                        <code class="shrink-0 font-mono text-red-600 dark:text-red-400">403</code>
                        <div>
                            <p class="font-medium text-gray-900 dark:text-white">Production tokens require at least one verified domain for the site</p>
                            <p class="text-gray-500 dark:text-gray-400">Add and verify a domain for your site before using a production token.</p>
                        </div>
                    </div>
                </div>
            </div>
