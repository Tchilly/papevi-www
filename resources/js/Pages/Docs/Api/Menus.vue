    ...
    <DocsLayout>
        ...
        <div class="space-y-10">
            <div class="space-y-3 border-b border-gray-200 pb-10 dark:border-white/8">
                ...
                <h1 class="text-4xl font-bold tracking-[-0.025em] text-gray-900 dark:text-white">Menus API</h1>
            ...
            <!-- GET /menus -->
            <div class="space-y-4">
                <h2 id="get-menus" class="scroll-mt-24 text-xl font-semibold tracking-[-0.015em] text-gray-900 dark:text-white">GET /menus</h2>
...
curl <span class="text-brand-300">"https://api.papevi.app/api/v1/menus?filter[is_primary]=true&amp;include=items"</span> \
  -H <span class="text-brand-300">"Authorization: Bearer &lt;token&gt;"</span></code></pre>
            ...
            <!-- GET /menus/{slug} -->
            <div class="space-y-4">
                <h2 id="get-menus-id" class="scroll-mt-24 text-xl font-semibold tracking-[-0.015em] text-gray-900 dark:text-white">GET /menus/{slug}</h2>
