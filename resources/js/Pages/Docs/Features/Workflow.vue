        ...
        <div class="space-y-10">
            <div class="space-y-3 border-b border-gray-200 pb-10 dark:border-white/8">
                ...
                <p class="max-w-xl text-lg text-gray-600 dark:text-gray-300">
                    Every page moves through a deterministic set of states. Status is computed live from timestamps —
            ...
            <div class="space-y-4">
                <Heading
                    ...
                    :level="3"
                    class="scroll-mt-24"
                    >Content states</Heading
                >

                <div class="space-y-3">
                    <div class="flex gap-4 rounded-xl border border-gray-200 p-5 dark:border-white/10">
                        <div
                            class="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-gray-100 dark:bg-white/10"
                        >
                        ...
                        <div>
                            <p class="flex items-center gap-2 text-sm font-semibold text-gray-900 dark:text-white">
                                Draft
                                <span
                                    class="rounded-md border border-gray-200 bg-gray-100 px-1.5 py-0.5 text-[10px] font-medium text-gray-500 dark:border-white/10 dark:bg-white/5 dark:text-gray-400"
                                    >API: hidden</span
                                >
                            </p>
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">
                                The default state. Authors iterate freely without touching live content. No
                    ...
                    <div class="flex gap-4 rounded-xl border border-gray-200 p-5 dark:border-white/10">
                        <div
                            class="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-yellow-100 dark:bg-yellow-500/10"
                        >
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">
                                Reviewers validate quality and policy via inline comments. Authors address feedback
                    ...
                    <div class="flex gap-4 rounded-xl border border-gray-200 p-5 dark:border-white/10">
                        <div
                            class="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-brand-100 dark:bg-brand-500/10"
                        >
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">
                                Administrative checkpoint before release. Content can be published immediately or
                                scheduled.
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        class="flex gap-4 rounded-xl border border-yellow-200 bg-yellow-50/30 p-5 dark:border-yellow-500/20 dark:bg-yellow-500/5"
                    >
                        <div
                            class="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-yellow-200 dark:bg-yellow-500/20"
                        >
                        ...
                        <div>
                            <p class="flex items-center gap-2 text-sm font-semibold text-gray-900 dark:text-white">
                                Scheduled
                                <span
                                    class="rounded-md border border-yellow-300 bg-yellow-100 px-1.5 py-0.5 text-[10px] font-medium text-yellow-700 dark:border-yellow-500/30 dark:bg-yellow-500/10 dark:text-yellow-400"
                                    >API: hidden until publish time</span
                                >
                            </p>
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">
                                <code class="rounded bg-gray-100 px-1 font-mono text-xs dark:bg-gray-800"
                                    >published_at</code
                                >
                                is set to a future time. The page becomes visible automatically when that time arrives
                    ...
                    <div
                        class="flex gap-4 rounded-xl border border-green-200 bg-green-50/30 p-5 dark:border-green-500/20 dark:bg-green-500/5"
                    >
                        <div
                            class="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-green-200 dark:bg-green-500/20"
                        >
                        ...
                        <div>
                            <p class="flex items-center gap-2 text-sm font-semibold text-gray-900 dark:text-white">
                                Published
                                <span
                                    class="rounded-md border border-green-300 bg-green-100 px-1.5 py-0.5 text-[10px] font-medium text-green-700 dark:border-green-500/30 dark:bg-green-500/10 dark:text-green-400"
                                    >API: visible</span
                                >
                            </p>
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">
            ...
            <div class="space-y-4">
                ...
                <p class="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
                    Set <strong class="font-medium text-gray-900 dark:text-white">Publish at</strong> to schedule a
                    go-live. Set <strong class="font-medium text-gray-900 dark:text-white">Unpublish at</strong> to
                    expire content automatically. A background job processes both every minute.
                </p>
                ...
                <div class="grid gap-4 text-sm sm:grid-cols-3">
                    <div class="space-y-2 rounded-xl border border-gray-200 p-4 dark:border-white/10">
                        ...
                        <ol class="list-inside list-decimal space-y-1 text-xs text-gray-500 dark:text-gray-400">
                ...
                >
                    <div>
                        ...
                        <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                            How every change is tracked, compared, and reverted
                        </p>
                    </div>
                    <svg
